    ...
    <section className="portfolio">
      ...
      <div className="portfolio__job">
        ...
        <a
          ...
          href="https://github.com/Gregory-mcbit/how-to-learn"
          target="_blank"
          rel="noreferrer"
        >
          {" "}
      ...
      <div className="portfolio__job">
        ...
        <a
          className="portfolio__job_link"
          href="https://github.com/Gregory-mcbit/russian-travel"
          target="_blank"
          rel="noreferrer"
        >
          {" "}
      ...
      <div className="portfolio__job">
        ...
        <a
          className="portfolio__job_link"
          href="https://github.com/Gregory-mcbit/react-mesto-api-full"
          target="_blank"
          rel="noreferrer"
        >
          {" "}
